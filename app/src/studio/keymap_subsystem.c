...
zmk_Response add_layer(const zmk_Request *req) {
...
zmk_Response remove_layer(const zmk_Request *req) {
...
zmk_Response restore_layer(const zmk_Request *req) {
...
zmk_Response set_layer_props(const zmk_Request *req) {
...
ZMK_RPC_SUBSYSTEM_HANDLER(keymap, add_layer, true);
ZMK_RPC_SUBSYSTEM_HANDLER(keymap, remove_layer, true);
ZMK_RPC_SUBSYSTEM_HANDLER(keymap, restore_layer, true);
ZMK_RPC_SUBSYSTEM_HANDLER(keymap, set_layer_props, true);
