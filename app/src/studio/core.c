...
ZMK_EVENT_IMPL(zmk_studio_core_unlock_requested);
...
void zmk_studio_core_initiate_unlock() {
    set_state(ZMK_STUDIO_CORE_LOCK_STATE_UNLOCKING);
    raise_zmk_studio_core_unlock_requested((struct zmk_studio_core_unlock_requested){});
}
